...
/**
 * bitonic_merge - Bitonic sequence sortd inside an array of integers.
...
/**
 * bitonic_seq - Array of integers convertd into a bitonic sequence.
 * @array: Array of integers.
...
/**
 * bitonic_sort - Array of integers sortd in ascending
 *                order using the bitonic sort algorithm.
 * @array: Array of integers.
 * @size: Array size.
 *
 * Description: Array printd after each swap. Only works for
